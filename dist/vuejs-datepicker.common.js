...
var Language = function Language (language, months, monthsAbbr, days, calendarweek) {
...
var prototypeAccessors = { language: { configurable: true },months: { configurable: true },monthsAbbr: { configurable: true },days: { configurable: true },calendarweek: { configurable: true } };
...
prototypeAccessors.calendarweek.get = function () {
  return this._calendarweek
};

prototypeAccessors.calendarweek.set = function (calendarweek) {
    if ( calendarweek === void 0 ) calendarweek = '';
...
var utils = {
  ...
  getWeekNumber: function getWeekNumber (date) {
    ...
    var week1 = new Date(this.getFullYear(date), 0, 4);
...
var DateInput = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"vdp-datepicker__calendar-wrapper",class:{'input-group' : _vm.bootstrapStyling}},[(_vm.calendarButton)?_c('span',{staticClass:"vdp-datepicker__calendar-button",class:{'input-group-prepend' : _vm.bootstrapStyling},style:({'cursor:not-allowed;' : _vm.disabled}),on:{"click":_vm.showCalendar}},[_c('span',{class:{'input-group-text' : _vm.bootstrapStyling}},[_c('i',{class:_vm.calendarButtonIcon},[(!_vm.calendarButtonIconContentAsHtml)?[_vm._v(_vm._s(_vm.calendarButtonIconContent))]:_c('span',{domProps:{"innerHTML":_vm._s(_vm.calendarButtonIconContent)}}),_vm._v(" "),(!_vm.calendarButtonIcon)?_c('span',[_vm._v("…")]):_vm._e()],2)])]):_vm._e(),_vm._v(" "),_c('input',{ref:_vm.refName,class:_vm.computedInputClass,attrs:{"type":_vm.inline ? 'hidden' : 'text',"name":_vm.name,"id":_vm.id,"open-date":_vm.openDate,"placeholder":_vm.placeholder,"clear-button":_vm.clearButton,"disabled":_vm.disabled,"required":_vm.required,"readonly":!_vm.typeable,"autocomplete":"off"},domProps:{"value":_vm.formattedValue},on:{"click":_vm.showCalendar,"keyup":_vm.parseTypedDate,"blur":_vm.inputBlurred}}),_vm._v(" "),(_vm.clearButton && _vm.selectedDate)?_c('span',{staticClass:"vdp-datepicker__clear-button",class:{'input-group-append' : _vm.bootstrapStyling},on:{"click":function($event){_vm.clearDate();}}},[_c('span',{class:{'input-group-text' : _vm.bootstrapStyling}},[_c('i',{class:_vm.clearButtonIcon},[(!_vm.clearButtonIcon)?_c('span',[_vm._v("×")]):_vm._e()])])]):_vm._e(),_vm._v(" "),_vm._t("afterDateInput")],2)},staticRenderFns: [],
  props: {
    selectedDate: Date,
    resetTypedDate: [Date],
...
(function(){ if(typeof document !== 'undefined'){ var head=document.head||document.getElementsByTagName('head')[0], style=document.createElement('style'), css=""; style.type='text/css'; if (style.styleSheet){ style.styleSheet.cssText = css; } else { style.appendChild(document.createTextNode(css)); } head.appendChild(style); } })();
var PickerDay = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.showDayView),expression:"showDayView"}],class:[_vm.calendarClass, 'vdp-datepicker__calendar', {'vdp-datepicker__calendar--week': _vm.calendarWeek}],style:(_vm.calendarStyle),on:{"mousedown":function($event){$event.preventDefault();}}},[_vm._t("beforeCalendarHeader"),_vm._v(" "),_c('header',[_c('span',{staticClass:"prev",class:{'disabled': _vm.isLeftNavDisabled},on:{"click":function($event){_vm.isRtl ? _vm.nextMonth() : _vm.previousMonth();}}},[_vm._v("<")]),_vm._v(" "),_c('span',{staticClass:"day__month_btn",class:_vm.allowedToShowView('month') ? 'up' : '',on:{"click":_vm.showMonthCalendar}},[_vm._v(_vm._s(_vm.isYmd ? _vm.currYearName : _vm.currMonthName)+" "+_vm._s(_vm.isYmd ? _vm.currMonthName : _vm.currYearName))]),_vm._v(" "),_c('span',{staticClass:"next",class:{'disabled': _vm.isRightNavDisabled},on:{"click":function($event){_vm.isRtl ? _vm.previousMonth() : _vm.nextMonth();}}},[_vm._v(">")])]),_vm._v(" "),_c('div',{class:{ 'flex-ltr': !_vm.isRtl, 'flex-rtl': _vm.isRtl }},[(_vm.calendarWeek)?_c('span',{staticClass:"cell day-header"},[_vm._v(_vm._s(_vm.translation.calendarweek))]):_vm._e(),_vm._v(" "),_vm._l((_vm.daysOfWeek),function(d){return _c('span',{key:d.timestamp,staticClass:"cell day-header"},[_vm._v(_vm._s(d))])}),_vm._v(" "),(_vm.calendarWeek)?_c('span',{staticClass:"cell weeknumber"},[_vm._v(_vm._s(_vm.weeknumber(0)))]):_vm._e(),_vm._v(" "),(_vm.blankDays > 0)?_vm._l((_vm.blankDays),function(d){return _c('span',{key:d.timestamp,staticClass:"cell day blank"})}):_vm._e(),_vm._v(" "),_vm._l((_vm.days),function(day,index){return [(_vm.showCalendarWeek(day, index))?_c('span',{staticClass:"cell weeknumber"},[_vm._v(_vm._s(_vm.weeknumber(index + 1)))]):_vm._e(),_vm._v(" "),_c('span',{key:day.timestamp,staticClass:"cell day",class:_vm.dayClasses(day),domProps:{"innerHTML":_vm._s(_vm.dayCellContent(day))},on:{"click":function($event){_vm.selectDate(day);}}}),_vm._v(" "),(_vm.showCalendarWeek(day, index, false))?_c('span',{staticClass:"cell weeknumber"},[_vm._v(_vm._s(_vm.weeknumber(index + 1)))]):_vm._e()]})],2)],2)},staticRenderFns: [],
  props: {
    showDayView: Boolean,
    selectedDate: Date,
    pageDate: Date,
  ...
  methods: {
     ...
     * @return {Boolean}
     */
    showCalendarWeek: function showCalendarWeek (day, index, before) {
     ...
     * @return {Number}
     */
    weeknumber: function weeknumber (index) {
